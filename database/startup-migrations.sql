...
-- Migrasjon: password_reset_tokens tabell
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM migrations WHERE name = 'add_password_reset_tokens') THEN
        ...
        INSERT INTO migrations (name) VALUES ('add_password_reset_tokens');
        RAISE NOTICE 'Migrasjon add_password_reset_tokens fullført';
    ELSE
        RAISE NOTICE 'Migrasjon add_password_reset_tokens allerede kjørt';
    END IF;
END $$;